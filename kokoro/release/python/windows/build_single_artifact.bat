...
mkdir vcprojects
pushd vcprojects
cmake -G "%generator%" -A %vcplatform% -T v140 -DCMAKE_SYSTEM_VERSION=10.0.22621.0 -Dprotobuf_BUILD_SHARED_LIBS=%BUILD_DLL% -Dprotobuf_UNICODE=%UNICODE% -Dprotobuf_BUILD_TESTS=OFF ../cmake || goto :error
