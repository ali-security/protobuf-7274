...
public final class GeneratorNames {
  ...
  static String getDefaultJavaPackage(FileOptions fileOptions, String filePackage) {
    // Replicate the logic from DefaultJavaPackage in java/names_internal.h.
  ...
  static String getProto2ApiDefaultJavaPackage(FileOptions fileOptions, String filePackage) {
    // Replicate the logic from Proto2DefaultJavaPackage in java/names_internal.h.
  ...
  private static String getFileClassNameImpl(
    ...
    // Replicate the logic of ClassNameResolver::GetFileImmutableClassName.
  ...
  static String getDefaultFileClassName(
    ...
    // Replicate the logic of ClassNameResolver::GetFileDefaultImmutableClassName.
  ...
  private static String stripProto(String filename) {
    // Replicate the logic of ClassNameResolver::StripProto.
  ...
  static String underscoresToCamelCase(String input, boolean capitalizeNextLetter) {
    // Replicate the logic of ClassNameResolver::UnderscoresToCamelCase.
  ...
  public static String getClassName(Descriptor message) {
    // Replicate the logic for ClassName from immutable/names.h
  ...
  private static String getClassFullName(
    ...
    // Replicate the logic for ClassNameResolver::GetJavaClassFullName from immutable/names.cc
    StringBuilder result = new StringBuilder();
    if (isOwnFile) {
